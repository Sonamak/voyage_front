...
<body>
    ...
    <div id="page">
        ...
        <div class="container margin_80_55">
                ...
                <div class="container fs-1 fw-bold mb-5 text-center w-100" style="font-size: 40px;font-weight: bold;">
                    Privacy Policy
                </div>

                <h1> What is Policy ?</h1>
                <div class="term-content">
                    <p>At Voyage Cleopatra, accessible from https://godiscoveregypt.com, one of our main priorities is
                        the privacy of our visitors. This Privacy Policy document contains types of information that is
                        collected and recorded by Voyage Cleopatra and how we use it.</p>
                    ...
                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                        website with regards to the information that they shared and/or collect in Voyage Cleopatra.
                        ...
                        this website. Our Privacy Policy was created with the help of the&nbsp;<a
                            style="box-sizing: border-box; background-color: transparent; color: #666666; text-decoration-line: none;"
                ...
                <div class="term-content">
                    ...
                    <h2
                        style="box-sizing: border-box; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-weight: 400; line-height: 1.1; color: #666666; margin: 0px 0px 18px; font-size: 16px; background-color: #ffffff;">
                ...
                <div class="term-content">
                    ...
                    <ul
                        style="box-sizing: border-box; margin-top: 0px; margin-bottom: 10px; color: #666666; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; background-color: #ffffff;">
                        ...
                        <li style="box-sizing: border-box;">Develop new products, services, features, and functionality
                        </li>
                        <li style="box-sizing: border-box;">Communicate with you, either directly or through one of our
                            partners, including for customer service, to provide you with updates and other information
                ...
                <div class="term-content">
                    <p><span
                            style="color: #666666; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; background-color: #ffffff;">Voyage
                            Cleopatra follows a standard procedure of using log files. These files log visitors when
                ...
                <div class="term-content">
                    ...
                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                        that are used in their respective advertisements and links that appear on Voyage Cleopatra,
                    ...
                    <p>Note that Voyage Cleopatra has no access to or control over these cookies that are used by
                        third-party advertisers.</p>
                </div>
                <h1> Third Party Privacy Policies</h1>
                <div class="term-content">
                    <p>Voyage Cleopatra's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                ...
                <div class="term-content">
                    <p>Another part of our priority is adding protection for children while using the internet. We
                        ...
                        online activity.</p>
                    <p>Voyage Cleopatra does not knowingly collect any Personal Identifiable Information from children
